...
technical note, "Behavioral Canarying for Prompt Injection: Powerless Model
Probes with Explicit Coverage Semantics" (DOI: [10.5281/zenodo.21818564](https://doi.org/10.5281/zenodo.21818564)).
...
The reference implementation of the architecture this note describes is
separate, in [Little Canary](https://github.com/hermes-labs-ai/little-canary).
Security reports about that implementation — including anything related to
its actual behavior as a prompt-injection defense — belong in that
...
(<https://doi.org/10.5281/zenodo.21818564>) — please open an issue in this
